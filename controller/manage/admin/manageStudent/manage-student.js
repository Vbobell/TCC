...
class ManageStudent {
    ...
    removeStudent(parameters, callback) {
        ...
        this.crudStudent.executeDelete('student_topic_comments', where, registry, data => {
            this.crudStudent.executeDelete('student_points', where, registry, data => {
                this.crudStudent.executeDelete('student_topic', where, registry, data => {
                    this.crudStudent.executeDelete('student_reward', where, registry, data => {
                        this.crudStudent.executeDelete('student_activity', where, registry, data => {
                            this.crudStudent.executeDelete('student_class', where, registry, data => {
                                this.crudStudent.executeDelete('student_discipline', where, registry, data => {
